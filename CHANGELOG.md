...
- [`6ed4d37`](https://github.com/OrjanSkarnes/changelog-action/commit/6ed4d37824a5ee846ce8e5ff39c839c42b4e7607) - **release.yml**: use new action inputs *(commit by [@OrjanSkarnes](https://github.com/OrjanSkarnes))*(issues: [SL-1603](https://jira.finods.com//browse/SL-1603))
...
[0.9.0]: https://github.com/OrjanSkarnes/changelog-action/compare/0.6.8...0.9.0